...
func TestDelete(t *testing.T) {
	t.Log(application.DeleteApplicationPkgs(repository.OptToDeleteApplicationPkgs{UpdatedAt: "2023-05-22"}))
	t.Log(base.DeleteBasePkgs(repository.OptToDeleteApplicationPkgs{UpdatedAt: "2023-05-22"}))
}
